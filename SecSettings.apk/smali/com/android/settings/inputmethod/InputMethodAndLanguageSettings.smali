...
.method public onResume()V
    ...
    invoke-virtual {v8, p0, v12}, Landroid/hardware/input/InputManager;->registerInputDeviceListener(Landroid/hardware/input/InputManager$InputDeviceListener;Landroid/os/Handler;)V
    ...
    .line 253
    .local v6, specialLocaleCodes:[Ljava/lang/String;
    invoke-virtual {p0}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->getResources()Landroid/content/res/Resources;
    ...
    .line 260
    .local v7, specialLocaleLanguages:[Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v8}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->hasOnlyOneLanguageInstance(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v8, v6, v7}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->getDisplayLanguage(Ljava/util/Locale;[Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local v6           #specialLocaleCodes:[Ljava/lang/String;
    .end local v7           #specialLocaleLanguages:[Ljava/lang/String;
    :cond_0
    const-string v8, "VZW"
    ...
    sget-object v11, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->sHardKeyboardKeys:[Ljava/lang/String;

    aget-object v11, v11, v2

    invoke-virtual {v8, v11}, Landroid/preference/PreferenceCategory;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    sget-object v11, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->sSystemSettingNames:[Ljava/lang/String;
    ...
    .restart local v6       #specialLocaleCodes:[Ljava/lang/String;
    .restart local v7       #specialLocaleLanguages:[Ljava/lang/String;
    :cond_2
    iget-object v8, v1, Landroid/content/res/Configuration;->locale:Ljava/util/Locale;

    iget-object v11, v1, Landroid/content/res/Configuration;->locale:Ljava/util/Locale;

    invoke-virtual {v8, v11}, Ljava/util/Locale;->getDisplayName(Ljava/util/Locale;)Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mImis:Ljava/util/List;

    invoke-static {p0, v8, v9, v12}, Lcom/android/settings/inputmethod/InputMethodAndSubtypeUtil;->loadInputMethodSubtypeList(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Ljava/util/Map;)V
